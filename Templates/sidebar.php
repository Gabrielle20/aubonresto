    ...
    <div class="sidebarclass">
        ...
        <div class="sidebarBody text-dark vh-100">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li> <a href="?page=pageProfile&articles=allProducts" class="nav-link text-white sidebar"> <i class="fa fa-dashboard"></i><span class="ms-2">Liste des Produits</span> </a> </li>
                <li> <a href="?page=pageProfile&articles=newProduct" class="nav-link text-white sidebar"> <i class="fa fa-dashboard"></i><span class="ms-2">Ajouter un produit</span> </a> </li>
            </ul>
        </div>
    </div>
<?php endif; ?>